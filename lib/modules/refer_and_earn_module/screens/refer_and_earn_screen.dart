                    ...
                    child: Padding(
                        ...
                        child: Row(
                            ...
                            children: [
                              _buildImage(
                                  imagePath:
                                      Assets.socialMediaIconsInstagramIcon),
                              _buildImage(
                                  imagePath:
                                      Assets.socialMediaIconsTwitterIcon),
                              _buildImage(
                                  imagePath:
                                      Assets.socialMediaIconsFacebookIcon),
                              _buildImage(
                                  imagePath:
                                      Assets.socialMediaIconsWhatsappIcon),
                              _buildImage(
                                  imagePath: Assets.socialMediaIconsGoogleIcon),
                            ])),
                  ),
                  SizedBox(height: 34),
                  GestureDetector(
